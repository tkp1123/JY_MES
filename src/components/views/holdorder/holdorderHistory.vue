...
export default {
  ...
  data() {
    return {
      ...
      tableData: [
        {
          id: '141694176778518536',
          agentName: '二级代理002',
          memberName: '陈胜',
          cellPhoneNumber: '1354826457',
          stockSymbol: '000090',
          stockName: '天健集团',
          amount: 21000.0,
          price: 2.5,
